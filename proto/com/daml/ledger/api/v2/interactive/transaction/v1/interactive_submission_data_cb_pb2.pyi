...
class ExerciseDisplay(_message.Message):
...
class NodeDisplay(_message.Message):
    ...
    rollback: Rollback
    def __init__(self, create: _Optional[_Union[CreateDisplay, _Mapping]] = ..., fetch: _Optional[_Union[Fetch, _Mapping]] = ..., exercise: _Optional[_Union[ExerciseDisplay, _Mapping]] = ..., rollback: _Optional[_Union[Rollback, _Mapping]] = ...) -> None: ...
