...
class CreatedEvent(_message.Message):
    __slots__ = ("offset", "node_id", "contract_id", "template_id", "contract_key", "contract_key_hash", "create_arguments", "created_event_blob", "interface_views", "witness_parties", "signatories", "observers", "created_at", "package_name", "acs_delta", "representative_package_id")
    ...
    ACS_DELTA_FIELD_NUMBER: _ClassVar[int]
    REPRESENTATIVE_PACKAGE_ID_FIELD_NUMBER: _ClassVar[int]
    offset: int
    node_id: int
    contract_id: str
...
class InterfaceView(_message.Message):
    ...
    def __init__(self, interface_id: _Optional[_Union[_value_pb2.Identifier, _Mapping]] = ..., view_status: _Optional[_Union[_status_pb2.Status, _Mapping]] = ..., view_value: _Optional[_Union[_value_pb2.Record, _Mapping]] = ..., implementation_package_id: _Optional[str] = ...) -> None: ...
...
class ExercisedEvent(_message.Message):
    __slots__ = ("offset", "node_id", "contract_id", "template_id", "interface_id", "choice", "choice_argument", "acting_parties", "consuming", "witness_parties", "last_descendant_node_id", "exercise_result", "package_name", "implemented_interfaces", "acs_delta")
    OFFSET_FIELD_NUMBER: _ClassVar[int]
    NODE_ID_FIELD_NUMBER: _ClassVar[int]
    CONTRACT_ID_FIELD_NUMBER: _ClassVar[int]
    TEMPLATE_ID_FIELD_NUMBER: _ClassVar[int]
