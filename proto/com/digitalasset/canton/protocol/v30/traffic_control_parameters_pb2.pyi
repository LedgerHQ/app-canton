...
class TrafficControlParameters(_message.Message):
    __slots__ = ("max_base_traffic_amount", "max_base_traffic_accumulation_duration", "read_vs_write_scaling_factor", "set_balance_request_submission_window_size", "enforce_rate_limiting", "base_event_cost", "free_confirmation_responses")
    ...
    FREE_CONFIRMATION_RESPONSES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, max_base_traffic_amount: _Optional[int] = ..., max_base_traffic_accumulation_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., read_vs_write_scaling_factor: _Optional[int] = ..., set_balance_request_submission_window_size: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., enforce_rate_limiting: bool = ..., base_event_cost: _Optional[int] = ..., free_confirmation_responses: bool = ...) -> None: ...
