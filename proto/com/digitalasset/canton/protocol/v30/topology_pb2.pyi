from com.digitalasset.canton.crypto.v30 import crypto_pb2 as _crypto_pb2
from com.digitalasset.canton.protocol.v30 import sequencing_parameters_pb2 as _sequencing_parameters_pb2
from com.digitalasset.canton.protocol.v30 import synchronizer_parameters_pb2 as _synchronizer_parameters_pb2
...
class Enums(_message.Message):
    ...
    class ParticipantFeatureFlag(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PARTICIPANT_FEATURE_FLAG_ENABLE_MULTI_SYNCHRONIZER: _ClassVar[Enums.ParticipantFeatureFlag]
    ...
    PARTICIPANT_FEATURE_FLAG_ENABLE_MULTI_SYNCHRONIZER: Enums.ParticipantFeatureFlag
...
class VettedPackages(_message.Message):
    ...
    class VettedPackage(_message.Message):
        ...
        def __init__(self, package_id: _Optional[str] = ..., valid_from_inclusive: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., valid_until_exclusive: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
    PARTICIPANT_UID_FIELD_NUMBER: _ClassVar[int]
...
class LsuAnnouncement(_message.Message):
    ...
    def __init__(self, successor_physical_synchronizer_id: _Optional[str] = ..., upgrade_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
