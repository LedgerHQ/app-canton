...
class VettedPackage(_message.Message):
    ...
    package_name: str
    package_version: str
    def __init__(self, package_id: _Optional[str] = ..., valid_from_inclusive: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., valid_until_exclusive: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., package_name: _Optional[str] = ..., package_version: _Optional[str] = ...) -> None: ...
